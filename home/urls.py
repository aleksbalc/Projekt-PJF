...
urlpatterns = [
    ...
    path('generate-all-user-tasks-report/', views.showAllTasksReportForProgramista, name="generate-all-user-tasks-report"),
    path('generate-edited-dates-report/', views.createEditedDatesReport, name="create-edited-dates-raport"),
    path('generate-all-tasks-report/', views.showAllTasksReportForKierownik, name="generate-all-tasks-report"),
    path('generate-all-tasks-report-csv/', views.exportAllTasksReportCSV, name="generate-all-tasks-report-csv"),
    path('generate-all-tasks-report-pdf/', views.exportAllTasksReportPDF, name="generate-all-tasks-report-pdf"),
    path('generate-all-tasks-report-html/', views.exportAllTasksReportHTML, name="generate-all-tasks-report-html"),
    path('generate-all-tasks-report-csv-programista/', views.exportAllTasksReportCSVProgramista, name="generate-all-tasks-report-csv-programista"),
    path('generate-all-tasks-report-pdf-programista/', views.exportAllTasksReportPDFProgramista, name="generate-all-tasks-report-pdf-programista"),
    path('generate-all-tasks-report-html-programista/', views.exportAllTasksReportHTMLProgramista, name="generate-all-tasks-report-html-programista"),
